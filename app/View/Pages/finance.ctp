      ...
      <div class="stage-box">
        ...
        <div class="stage-box__desc">
          <div class="img fl-left">
            <img src="<?= Router::url('/img/bg-finance.png') ?>" alt=""></div>
          <div class="text fl-left">
            <img src="<?= Router::url('/img/c/prof-info.png') ?>" alt=""></div>
        </div>
        <div class="circles">
          <a href="<?= Router::url('/pages/info/07-00?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-00</div>
          </a>
          <a href="<?= Router::url('/pages/info/07-01?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-01</div>
          </a>
          <a href="<?= Router::url('/pages/info/07-02?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-02</div>
          </a>
          <a href="<?= Router::url('/pages/info/07-03?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-03</div>
          </a>
          <a href="<?= Router::url('/pages/info/07-04?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-04</div>
          </a>
          <a href="<?= Router::url('/pages/info/07-05?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-05</div>
          </a>
          <a href="<?= Router::url('/pages/info/07-06?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-06</div>
          </a>
          <a href="<?= Router::url('/pages/info/07-07?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">07-07</div>
          </a>
          <a href="<?= Router::url('/pages/info/06-05?from=finance') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
