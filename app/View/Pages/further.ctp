  ...
  <div class="stage-bg__in">
    <div class="l-main__in">
      <div class="stage-box">
        ...
        <div class="circles">
          <a href="<?= Router::url('/pages/info/12-01?from=further') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">12-01</div>
          </a>
          <a href="<?= Router::url('/pages/info/12-02?from=further') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">12-02</div>
          </a>
          <a href="<?= Router::url('/pages/info/12-03?from=further') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">12-03</div>
          </a>
          <a href="<?= Router::url('/pages/info/12-04?from=further') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">12-04</div>
          </a>
          <a href="<?= Router::url('/pages/info/01-01?from=further') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
            <div class="circle__name">01-01</div>
          </a>
          <a href="<?= Router::url('/pages/info/02-01?from=further') ?>" class="circle">
            <div class="circle__pic">
              <img src="<?= Router::url('/img/cir/lock.png') ?>" alt=""></div>
